...
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("bash " .. scriptsDir .. "/dropdown_term.sh"), { description = "Open Dropdown Terminal" })
...
hl.bind(mainMod .. " + " .. "Escape", hl.dsp.exec_cmd(ipc .. "panel-toggle control-center"), { description = "Open Control Center" })
hl.bind(mainMod .. " + " .. "Comma", hl.dsp.exec_cmd(ipc .. "settings-toggle"), { description = "Open Settings" })
hl.bind(mainMod .. " + " .. "F1", hl.dsp.exec_cmd(ipc .. "panel-toggle blackbartblues/keymap:panel"), { description = "Open Keybinds Cheatsheet" })
...
hl.bind(mainMod .. " + " .. "X", hl.dsp.exec_cmd(ipc .. "panel-toggle noctalia/notes:panel"), { description = "Open Scratchpad" })
-- hl.bind(mainMod .. " + " .. "Slash", hl.dsp.exec_cmd(ipc .. "panel-toggle weinguyen/opencode-companion:panel-fill"), { description = "Open AI Assistant" })
-- hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "Slash", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call plugin:assistant-panel clear"), { description = "Clear AI Assistant Chat" })
...
hl.bind("xf86Rfkill", hl.dsp.exec_cmd(scriptsDir .. "/airplane_mode.sh"), { locked = true, description = "Airplane Mode" })
hl.bind(mainMod .. " + " .. "M", hl.dsp.exec_cmd(ipc .. "panel-toggle ahmedhossamdev/display-arrange:panel"), { description = "Open Display Arrange" })
-- -- MEDIA
-- Audio
...
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd(ipc .. "brightness-down"), { locked = true, description = "Brightness Down" })
...
hl.bind(mainMod .. " + " .. "Print", hl.dsp.exec_cmd(scriptsDir .. "/screenshot.sh -m area -z"), { description = "Screenshot Area" })
hl.bind("SHIFT" .. " + " .. "Print", hl.dsp.exec_cmd(ipc .. "plugin noctalia/screen_recorder:service all toggle"), { description = "Record Screen" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "Print", hl.dsp.exec_cmd(scriptsDir .. "/record.sh -M area -a -m"), { description = "Record Area" })
-- hl.bind("SHIFT" .. " + " .. "Print", hl.dsp.exec_cmd(scriptsDir .. "/record.sh -M fullscreen -a -m"), { description = "Record Screen" })

-- Tools
hl.bind(mainMod .. " + " .. "Insert", hl.dsp.exec_cmd(scriptsDir .. "/ocr_scan.sh"), { description = "OCR Scan" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "Insert", hl.dsp.exec_cmd(scriptsDir .. "/qr_scan.sh"), { description = "QR Scan" })
hl.bind(mainMod .. " + " .. "D", hl.dsp.exec_cmd("pkill -USR1 -f 'wayscriber --daemon'"), { description = "Toggle Annotation" })
...
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "F", hl.dsp.window.fullscreen({ mode = "maximized" }), { description = "Maximize Window" })
...
hl.bind(mainMod .. " + " .. "mouse:274", hl.dsp.exec_cmd("bash " .. scriptsDir .. "/hypr_minimize.sh toggle"), { description = "Toggle Minimize Tray" })
hl.bind(mainMod .. " + " .. "CTRL" .. " + " .. "mouse:274", hl.dsp.exec_cmd("bash " .. scriptsDir .. "/hypr_minimize.sh push"), { description = "Minimize Window" })
hl.bind(mainMod .. " + " .. "CTRL + ALT" .. " + " .. "mouse:274", hl.dsp.exec_cmd("bash " .. scriptsDir .. "/hypr_minimize.sh push --all"), { description = "Minimize All Windows" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "mouse:274", hl.dsp.exec_cmd("bash " .. scriptsDir .. "/hypr_minimize.sh pop"), { description = "Restore Minimized Window" })
hl.bind(mainMod .. " + " .. "SHIFT + ALT" .. " + " .. "mouse:274", hl.dsp.exec_cmd("bash " .. scriptsDir .. "/hypr_minimize.sh pop --all"), { description = "Restore All Minimized Windows" })
...
-- Resize
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "Left", hl.dsp.window.resize({ x = -50, y = 0 }), { repeating = true, description = "Resize Window Left" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "Right", hl.dsp.window.resize({ x = 50, y = 0 }), { repeating = true, description = "Resize Window Right" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "Up", hl.dsp.window.resize({ x = 0, y = -50 }), { repeating = true, description = "Resize Window Up" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "Down", hl.dsp.window.resize({ x = 0, y = 50 }), { repeating = true, description = "Resize Window Down" })
...
-- Special Workspace
hl.bind(mainMod .. " + " .. "code:90", hl.dsp.workspace.toggle_special("num_0"), { description = "Toggle Special Workspace 0" })
hl.bind(mainMod .. " + " .. "code:87", hl.dsp.workspace.toggle_special("num_1"), { description = "Toggle Special Workspace 1" })
hl.bind(mainMod .. " + " .. "code:88", hl.dsp.workspace.toggle_special("num_2"), { description = "Toggle Special Workspace 2" })
hl.bind(mainMod .. " + " .. "code:89", hl.dsp.workspace.toggle_special("num_3"), { description = "Toggle Special Workspace 3" })
hl.bind(mainMod .. " + " .. "code:83", hl.dsp.workspace.toggle_special("num_4"), { description = "Toggle Special Workspace 4" })
hl.bind(mainMod .. " + " .. "code:84", hl.dsp.workspace.toggle_special("num_5"), { description = "Toggle Special Workspace 5" })
hl.bind(mainMod .. " + " .. "code:85", hl.dsp.workspace.toggle_special("num_6"), { description = "Toggle Special Workspace 6" })
hl.bind(mainMod .. " + " .. "code:79", hl.dsp.workspace.toggle_special("num_7"), { description = "Toggle Special Workspace 7" })
hl.bind(mainMod .. " + " .. "code:80", hl.dsp.workspace.toggle_special("num_8"), { description = "Toggle Special Workspace 8" })
hl.bind(mainMod .. " + " .. "code:81", hl.dsp.workspace.toggle_special("num_9"), { description = "Toggle Special Workspace 9" })

hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "code:90", hl.dsp.window.move({ workspace = "special:num_0" }), { description = "Move Window to Special Workspace 0" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "code:87", hl.dsp.window.move({ workspace = "special:num_1" }), { description = "Move Window to Special Workspace 1" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "code:88", hl.dsp.window.move({ workspace = "special:num_2" }), { description = "Move Window to Special Workspace 2" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "code:89", hl.dsp.window.move({ workspace = "special:num_3" }), { description = "Move Window to Special Workspace 3" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "code:83", hl.dsp.window.move({ workspace = "special:num_4" }), { description = "Move Window to Special Workspace 4" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "code:84", hl.dsp.window.move({ workspace = "special:num_5" }), { description = "Move Window to Special Workspace 5" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "code:85", hl.dsp.window.move({ workspace = "special:num_6" }), { description = "Move Window to Special Workspace 6" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "code:79", hl.dsp.window.move({ workspace = "special:num_7" }), { description = "Move Window to Special Workspace 7" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "code:80", hl.dsp.window.move({ workspace = "special:num_8" }), { description = "Move Window to Special Workspace 8" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "code:81", hl.dsp.window.move({ workspace = "special:num_9" }), { description = "Move Window to Special Workspace 9" })

hl.bind(mainMod .. " + CTRL + code:90", hl.dsp.window.move({ workspace = "special:num_0", follow = false }), { description = "Move Window Silently to Special Workspace 0" })
hl.bind(mainMod .. " + CTRL + code:87", hl.dsp.window.move({ workspace = "special:num_1", follow = false }), { description = "Move Window Silently to Special Workspace 1" })
hl.bind(mainMod .. " + CTRL + code:88", hl.dsp.window.move({ workspace = "special:num_2", follow = false }), { description = "Move Window Silently to Special Workspace 2" })
hl.bind(mainMod .. " + CTRL + code:89", hl.dsp.window.move({ workspace = "special:num_3", follow = false }), { description = "Move Window Silently to Special Workspace 3" })
hl.bind(mainMod .. " + CTRL + code:83", hl.dsp.window.move({ workspace = "special:num_4", follow = false }), { description = "Move Window Silently to Special Workspace 4" })
hl.bind(mainMod .. " + CTRL + code:84", hl.dsp.window.move({ workspace = "special:num_5", follow = false }), { description = "Move Window Silently to Special Workspace 5" })
hl.bind(mainMod .. " + CTRL + code:85", hl.dsp.window.move({ workspace = "special:num_6", follow = false }), { description = "Move Window Silently to Special Workspace 6" })
hl.bind(mainMod .. " + CTRL + code:79", hl.dsp.window.move({ workspace = "special:num_7", follow = false }), { description = "Move Window Silently to Special Workspace 7" })
hl.bind(mainMod .. " + CTRL + code:80", hl.dsp.window.move({ workspace = "special:num_8", follow = false }), { description = "Move Window Silently to Special Workspace 8" })
hl.bind(mainMod .. " + CTRL + code:81", hl.dsp.window.move({ workspace = "special:num_9", follow = false }), { description = "Move Window Silently to Special Workspace 9" })
...
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "bracketright", hl.dsp.window.move({ workspace = "r+1" }), { description = "Move Window to Next Workspace" })
hl.bind(mainMod .. " + " .. "SHIFT" .. " + " .. "bracketleft", hl.dsp.window.move({ workspace = "r-1" }), { description = "Move Window to Previous Workspace" })
...
hl.bind(mainMod .. " + CTRL + code:10", hl.dsp.window.move({ workspace = 1, follow = false }), { description = "Move Window Silently to Workspace 1" })
hl.bind(mainMod .. " + CTRL + code:11", hl.dsp.window.move({ workspace = 2, follow = false }), { description = "Move Window Silently to Workspace 2" })
hl.bind(mainMod .. " + CTRL + code:12", hl.dsp.window.move({ workspace = 3, follow = false }), { description = "Move Window Silently to Workspace 3" })
hl.bind(mainMod .. " + CTRL + code:13", hl.dsp.window.move({ workspace = 4, follow = false }), { description = "Move Window Silently to Workspace 4" })
hl.bind(mainMod .. " + CTRL + code:14", hl.dsp.window.move({ workspace = 5, follow = false }), { description = "Move Window Silently to Workspace 5" })
hl.bind(mainMod .. " + CTRL + code:15", hl.dsp.window.move({ workspace = 6, follow = false }), { description = "Move Window Silently to Workspace 6" })
hl.bind(mainMod .. " + CTRL + code:16", hl.dsp.window.move({ workspace = 7, follow = false }), { description = "Move Window Silently to Workspace 7" })
hl.bind(mainMod .. " + CTRL + code:17", hl.dsp.window.move({ workspace = 8, follow = false }), { description = "Move Window Silently to Workspace 8" })
hl.bind(mainMod .. " + CTRL + code:18", hl.dsp.window.move({ workspace = 9, follow = false }), { description = "Move Window Silently to Workspace 9" })
hl.bind(mainMod .. " + CTRL + code:19", hl.dsp.window.move({ workspace = 10, follow = false }), { description = "Move Window Silently to Workspace 10" })

hl.bind(mainMod .. " + CTRL + bracketright", hl.dsp.window.move({ workspace = "r+1", follow = false }), { description = "Move Window Silently to Next Workspace" })
hl.bind(mainMod .. " + CTRL + bracketleft", hl.dsp.window.move({ workspace = "r-1", follow = false }), { description = "Move Window Silently to Previous Workspace" })
